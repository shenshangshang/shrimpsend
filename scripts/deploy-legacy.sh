...
# 用法:
#   ./scripts/deploy-legacy.sh          交互式部署（先选择国内/海外集群，再拉代码、构建、重启）
#   ./scripts/deploy-legacy.sh stop     仅停止服务
#   ./scripts/deploy-legacy.sh status   查看服务状态
#   ./scripts/deploy-legacy.sh logs     查看日志路径
#
...
#   SPRING_PROFILE=prod-overseas CLUSTER_LABEL='海外 (ShrimpSend)' ./scripts/deploy-legacy.sh
...
case "${1:-}" in
  ...
  help|--help|-h)
    echo "用法:"
    echo "  ./scripts/deploy-legacy.sh          交互式部署（先询问国内/海外集群）"
    echo "  ./scripts/deploy-legacy.sh stop     停止服务"
    echo "  ./scripts/deploy-legacy.sh status   查看服务状态"
    echo "  ./scripts/deploy-legacy.sh logs     查看日志文件"
    echo ""
    echo "环境变量（非交互式）:"
...
echo ""
echo "  停止服务: ./scripts/deploy-legacy.sh stop"
echo "  查看状态: ./scripts/deploy-legacy.sh status"
echo "  查看日志: ./scripts/deploy-legacy.sh logs"
echo "=========================================="
